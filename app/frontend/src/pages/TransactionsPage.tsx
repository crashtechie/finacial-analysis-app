    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">A list of all your financial transactions.</p>
        </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-4">
        ...
        <div className="flex items-end space-x-2">
          <button type="button" className="btn-primary flex-1" onClick={handleFilter}>
            Filter
          </button>
          <button type="button" className="btn-secondary flex-1" onClick={handleClearFilters}>
            Clear
          </button>
        </div>
      </div>
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {transactions.map((transaction) => (
                    <tr key={transaction.id}>
                      ...
                      <td
                        className={`whitespace-nowrap px-3 py-4 text-sm text-right font-medium ${getAmountColorClass(transaction.amount)}`}
                      >
