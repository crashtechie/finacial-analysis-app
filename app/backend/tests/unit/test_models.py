...
class TestModels:
    ...
    def test_institution_can_be_created(self):
        ...
        inst = Institution.objects.create(name="Test Bank", identifier="testbank")
    ...
    def test_account_balance_calculation(self):
        ...
        account = Account.objects.create(
            institution=inst, name="Checking", account_number="1234", account_type="checking"
        )
    ...
    def test_category_hierarchy(self):
        ...
        child = Category.objects.create(name="Groceries", slug="groceries", parent=parent)
    ...
    def test_transaction_properties(self):
        ...
        inst = Institution.objects.create(name="Bank", identifier="bank")
        account = Account.objects.create(institution=inst, name="Checking", account_number="1234")
        category = Category.objects.create(name="Test", slug="test")
